def Ninety_nine_Bottles_of_Beer_on_the_Wall num_of_bottles
	while num_of_bottles > 0
		...
		puts ("Take one down and pass it around, "+ (english_number num_of_bottles) + " bottles of beer on the wall.")
